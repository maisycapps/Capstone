/*
  ...
  - You are about to drop the column `end` on the `Trips` table. All the data in the column will be lost.
  - You are about to drop the column `start` on the `Trips` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Trips" DROP COLUMN "end",
DROP COLUMN "start",
